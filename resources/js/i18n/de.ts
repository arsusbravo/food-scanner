...
export const messages: MessageSchema = {
    ...
    log_waste: {
        ...
        ai_shortcut: 'Oder KI-Scan nutzen, um Daten aus einem Foto zu extrahieren',
    ...
    ai_scan: {
        title: 'KI-Abfallscanner',
        subtitle: 'Machen Sie ein Foto des Lebensmittelabfalls oder eines handgeschriebenen Zettels. Die KI extrahiert die Daten.',
        upload_label: 'Foto aufnehmen oder hochladen',
        upload_hint: 'JPG, PNG, WebP bis 10 MB',
        change_photo: 'Tippen, um Foto zu ändern',
        analyse: 'Mit KI analysieren',
        analysing: 'Analysiere…',
        review_title: 'KI-Ergebnisse prüfen',
